...
app.post("/api", (req, res) => {
    ...
    .then(function (response) {
        ...
        var movieBox = "/movie_theatrical_chart_entries?filter=movie_od_name%20like%20(%22" + userSearchMovie + "%%22)%20AND%20movie_chart_type_od_name=%22" + boxFrequency + "%22";
        ...
        axios.get(dataURL, options).then(function(data) {
            ...
            //     res.json(util.inspect(data.data[i]));
            // }
        });
    });
});
